...
export const MainGameLayout = () => {
    ...
    const [game] = useState(() => new BibleQuizGame(
        localStorage.getItem('quizPlayer') || 'Quiz Master',
        GENERAL_QUESTIONS
    ));
    ...
    const [showNameModal, setShowNameModal] = useState(!localStorage.getItem('quizPlayer') || localStorage.getItem('quizPlayer') === 'Quiz Master');
    ...
    useEffect(() => {
        ...
        // Single 60s round timer — ticks continuously while in game screen
    ...
    }, [gameState.currentScreen, gameState.currentQuestion, player]);
            ...
            <div className="main-content">
                ...
                {showNameModal && (
                    <NameModal
                        ...
                        onCancel={localStorage.getItem('quizPlayer') ? () => setShowNameModal(false) : undefined}
                    />
                )}
            </div>
        </div>

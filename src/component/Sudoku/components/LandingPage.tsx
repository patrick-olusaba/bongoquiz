        ...
        <div className="main-sudoku-landing-container">
            ...
            <div className="sudoku-landing-topbar">
                ...
                {isMenuOpen && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            {[
                                {
                                    icon: <HelpCircle size={16}/>, label: 'How to Play', action: () => {
                                        setShowHtp(true);
                                        setIsMenuOpen(false);
                                    }
                                },
                                ...
                                {
                                    icon: <User size={16}/>, label: 'Edit Profile', action: () => {
                                        setIsEditing(true);
                                        setIsMenuOpen(false);
                                    }
                                },
                ...
                <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
                    ...
                    <button onClick={() => setIsMenuOpen(true)} className="sudoku-landing-menu-btn"

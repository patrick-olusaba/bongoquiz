  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      const res = await fetch('https://us-central1-bongoquiz-23ad4.cloudfunctions.net/deposit', {
        ...
        body: JSON.stringify({ name, phone: phone254, amount, trigger: 'R1R2', game: 'GENERALKNOWLEDGE' }),
      }).then(r => r.json());
      ...
      // Listen on payments doc (main collection)
  ...
  return (
    <div className="ded-overlay">
      <div className="ded-modal">
        ...
        <h2 className="ded-title">General Knowledge Quiz</h2>

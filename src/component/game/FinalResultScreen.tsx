...
export const FinalResultScreen: FC<Props> = ({
    ...
    useEffect(() => {
        ...
        // Note: Game session is already saved by BongoMain.tsx using the saveGameSession cloud function
        // which properly handles both session saving and leaderboard updates

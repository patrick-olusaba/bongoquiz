...
export class BibleQuizGame {
    ...
    getLevelDifficulty(): string {
        switch(this.currentLevel) {
            case 1: return "Easy - Basic general knowledge";
            case 2: return "Medium - Intermediate knowledge";
            case 3: return "Hard - Advanced knowledge";
            default: return "Expert - Knowledge mastery";
        }
    }

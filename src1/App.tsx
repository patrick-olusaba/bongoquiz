...
import logoBg from './assets/bongo-logo.webp';
...
const SumTen = lazy(() => import("./component/SumTen/App.tsx"));
    ...
    return (
        <Suspense fallback={<LoadingScreen />}>
            ...
            <Routes>
                ...
                <Route path="/bongo-quiz"  element={<BongoMain initialScreen="arena" />} />
                ...
                <Route path="/sum-ten" element={<SumTen />} />

...
import { User, Pencil, CreditCard, Medal, Target, Info, Loader, UserCog } from 'lucide-react';
...
export const LandingPage: React.FC<LandingPageProps> = ({ onPlay }) => {
    ...
    const settingsItems: SettingsItem[] = [
        { key: 'profile', label: 'Edit Profile', icon: <UserCog size={18} />, onClick: () => setIsEditModalOpen(true) },
    ];

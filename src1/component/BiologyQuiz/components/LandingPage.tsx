...
import { User, X, Copy, MessageCircle, Check, User as UserIcon, HelpCircle, History, Share2, UserCog } from 'lucide-react';
...
export const LandingPage: React.FC<Props> = ({ onStartGame, playerName, setPlayerName, playerPhone, setPlayerPhone, leaderboard }) => {
    ...
    const settingsItems: SettingsItem[] = [
        { key: 'htp', label: 'How to Play', icon: <HelpCircle size={18} />, onClick: () => setActiveModal('howToPlay') },
        { key: 'history', label: 'Game History', icon: <History size={18} />, onClick: loadHistory },
        { key: 'share', label: 'Share', icon: <Share2 size={18} />, onClick: handleShareClick },

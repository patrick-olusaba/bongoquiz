...
const GAMES = [
    ...
    { key: "sumTen", label: "SumTen", collection: "sumTenLeaderboard" },
] as const;
...
const emptyScores = (): ScoreMap => ({ bongo: 0, bible: 0, math: 0, biology: 0, general: 0, sudoku: 0, connectDots: 0, sumTen: 0 });
